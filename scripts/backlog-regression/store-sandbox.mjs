// scripts/backlog-regression/store-sandbox.mjs — a minimal store sandbox for the deterministic runtime
// backlog-gate regression: fixture → docs/, working-tree runtime/ with the registry seeded from
// SEED_CHECKS, the backlog-lint skill dir (the content checks delegate into its lib/rules.mjs — the
// single source of truth for the 11 rules), yaml+zod symlinks, git init+commit.
