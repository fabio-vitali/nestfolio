...
const EXPECTED = [
  ...
  'MANDATE_REVOKED','MANDATE_SNAPSHOT_CREATED','MONTHLY_REPORT_CREATED','MONTHLY_REPORT_UPDATED',
  'NOTIFICATION_CREATED','NOTIFICATION_READ','NOTIFICATION_UPDATED','ONBOARDING_COMPLETED',
  'OPERATING_MODE_CHANGED','RECOMMENDATION_PROPOSED','WITHDRAWAL_INITIATED',
].sort();
