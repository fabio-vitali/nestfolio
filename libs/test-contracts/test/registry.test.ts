...
const EXPECTED = [
  ...
  'BALANCE_UPDATED',
  'BROKER_CIRCUIT_CLOSED','BROKER_CIRCUIT_OPEN','BROKER_HEAL_ESCALATED',
  'CONSTRUCT_PORTFOLIO',
  ...
  'DEPOSIT_DETECTED','DEPOSIT_INITIATED','DEPOSIT_SETTLED','EXECUTION_MODE_CHANGED','EXECUTION_MODE_CHANGE_UPDATED','EXPLANATION_GENERATED',
  ...
  'INVESTOR_PROFILE_UPDATED','LEDGER_ENTRY_RECORDED','MANDATE_ISSUED','MANDATE_REAFFIRMED',
  ...
  'ORDER_CANCELLED','ORDER_ESCALATED','ORDER_FILLED','ORDER_PARTIALLY_FILLED','ORDER_REJECTED','ORDER_SUBMITTED',
  'PORTFOLIO_COMPLETED','PORTFOLIO_FAILED','PORTFOLIO_UPDATED','RECOMMENDATION_PROPOSED',
  ...
  'WITHDRAWAL_INITIATED','WITHDRAWAL_SETTLED',
