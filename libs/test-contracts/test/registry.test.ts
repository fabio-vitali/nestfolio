...
const EXPECTED = [
  ...
  'ALPACA_ORDER_CANCEL_FAILED','ALPACA_ORDER_CANCELLED','ALPACA_ORDER_FILLED',
  'ALPACA_ORDER_PARTIALLY_FILLED','ALPACA_ORDER_PLACED','ALPACA_ORDER_REJECTED',
  'ALPACA_TRANSFER_COMPLETED','ALPACA_TRANSFER_FAILED','ALPACA_TRANSFER_INITIATED',
  'ALPHA_VANTAGE_ECONOMIC_INDICATOR_UPDATED','ALPHA_VANTAGE_NEWS_UPDATED',
  'CONSTRUCT_PORTFOLIO',
  ...
  'SIM_DEPOSIT_COMPLETED','SIM_ORDER_FILLED','SIM_ORDER_REJECTED','SIM_WITHDRAWAL_COMPLETED',
