...
import { invokeGraph } from '../src/agent-invoker';
import { AgentNodeMap } from '../src/graph-orchestrator';
import { AgentType } from '../src/model-config';

// Mock the graph-orchestrator to avoid real LangGraph compilation
jest.mock('../src/graph-orchestrator', () => {
  const actual = jest.requireActual('../src/graph-orchestrator');
  return {
    ...actual,
...
import { buildDecisionGraph } from '../src/graph-orchestrator';
