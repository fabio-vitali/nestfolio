import type { GoalInterpretation } from '@nestfolio/agent-core';
import type { RiskAssessment } from '@nestfolio/agent-core';
import type { MarketResearch } from '@nestfolio/agent-core';
import type { PortfolioConstruction } from '@nestfolio/agent-core';
import type { RebalancePlan } from '@nestfolio/agent-core';
import type { Explanation } from '@nestfolio/agent-core';
