/**
 * Value-first pipe for data transformation (like F#/Elixir).
 * First argument is the data, rest are transformation functions.
 *
 * NOT for handler wrapping — use applyMiddleware() from lambda-utils for that.
 */
