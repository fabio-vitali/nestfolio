...
export class PortfolioRepository extends TableRepository {
  ...
  readonly getOrCreatePortfolio = this.log('getOrCreatePortfolio',
    async (tenantId: string, portfolioId: string): Promise<Record<string, unknown>> => {
  ...
  readonly updatePortfolio = this.log('updatePortfolio',
    async (
      tenantId: string,
      portfolioId: string,
  ...
  readonly putPerformanceMetric = this.log('putPerformanceMetric',
    async (
      tenantId: string,
      portfolioId: string,
      period: string,
