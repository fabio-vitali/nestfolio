...
export class SnapshotImportedPipe implements Pipe<UnitOfWork<BusEvent<SnapshotImportedPayload>>, void> {
  constructor(private readonly repository: PortfolioRepository) {}

  feed(source: Highland.Stream<UnitOfWork<BusEvent<SnapshotImportedPayload>>>): Highland.Stream<void> {
