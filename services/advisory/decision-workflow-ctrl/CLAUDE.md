...
- CDC: DynamoDB Streams → decision-workflow-ctrl-egress (Lambda)
  ...
  - MandateSnapshot → MANDATE_SNAPSHOT_CREATED (insert only — operatingMode changes do NOT re-trigger first decision)
