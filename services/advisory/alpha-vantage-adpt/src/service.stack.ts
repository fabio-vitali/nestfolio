...
export class AlphaVantageAdptStack extends ServiceStack {
  constructor(
    ...
    const egress = new Egress(this, 'Egress', {
      ...
      eventTypes: {
        'AlphaVantageArticle': {
          insert: AlphaVantageAdptEventTypes.ALPHA_VANTAGE_NEWS_UPDATED,
          modify: AlphaVantageAdptEventTypes.ALPHA_VANTAGE_NEWS_UPDATED,
        },
        'EconomicIndicator': {
          insert: AlphaVantageAdptEventTypes.ECONOMIC_INDICATOR_UPDATED,
          modify: AlphaVantageAdptEventTypes.ECONOMIC_INDICATOR_UPDATED,
        },
      },
    });
