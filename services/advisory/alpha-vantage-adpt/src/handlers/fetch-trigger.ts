...
export const handler = async (): Promise<void> => {
  ...
  logger.info('Publishing FETCH_REQUESTED to advisory bus');
      ...
      Entries: [
        {
          ...
          Source: serviceName,
          DetailType: AlphaVantageAdptEventTypes.FETCH_REQUESTED,
          Detail: JSON.stringify({
            id: randomUUID(),
            type: AlphaVantageAdptEventTypes.FETCH_REQUESTED,
  ...
  logger.info('FETCH_REQUESTED published');
};
