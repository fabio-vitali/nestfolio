> **Deprecated:** This document has been superseded by `flows/investor-onboarding.flow.yaml` and the agent documentation system. See `docs/agent-system.md` for details.
