> **Deprecated:** This document has been superseded by `flows/portfolio-rebalance.flow.yaml` and the agent documentation system. See `docs/agent-system.md` for details.
