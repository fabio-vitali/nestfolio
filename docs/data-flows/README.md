...
| 04 | [Investor Onboarding](./investor-onboarding.md) | `investor`, `execution` | New investor completes onboarding wizard; investor-bff materializes profile records; investor-ctrl sends welcome notification; conditional deposit triggers execution domain |
