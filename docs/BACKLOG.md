...
rollup: core 27/31 done · captured 2/12 done
- core · active · [from-run-next-pre-ship-judge-binding-gap](backlog/from-run-next-pre-ship-judge-binding-gap.md)
- core · parking · [from-run-item-judge-binding-gap](backlog/from-run-item-judge-binding-gap.md)
...
- [from-run-next-pre-ship-judge-binding-gap](backlog/from-run-next-pre-ship-judge-binding-gap.md) [bug] `[epic:runtime-operationalization · core]`
