...
3. [investor-bff-mandate-accepted-at-field-undefined](backlog/investor-bff-mandate-accepted-at-field-undefined.md) [bug] — Test mutation selects Mandate.acceptedAt; the field was deleted from schema in commit e283b5f5 (2026-05-08 resplit). Test fixture rot + stale TypeScript MandateStatus interface in src/domain/models.ts.
