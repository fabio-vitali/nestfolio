...
rollup: core 30/32 done · captured 2/13 done
- core · queued · [from-run-themes-intake-bare-capabilities-conformance-gap](backlog/from-run-themes-intake-bare-capabilities-conformance-gap.md)
...
4. [from-run-themes-intake-bare-capabilities-conformance-gap](backlog/from-run-themes-intake-bare-capabilities-conformance-gap.md) [bug] `[epic:runtime-operationalization · core]`
