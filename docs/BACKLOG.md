...
rollup: core 28/32 done · captured 2/12 done
- core · queued · [from-run-item-judge-binding-gap](backlog/from-run-item-judge-binding-gap.md)
- core · parking · [from-run-themes-intake-bare-capabilities-conformance-gap](backlog/from-run-themes-intake-bare-capabilities-conformance-gap.md)
...
4. [from-run-item-judge-binding-gap](backlog/from-run-item-judge-binding-gap.md) [bug] `[epic:runtime-operationalization · core]`
