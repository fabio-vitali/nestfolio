...
rollup: core 29/32 done · captured 2/12 done
- core · queued · [runtime-operational-surface](backlog/runtime-operational-surface.md)
...
4. [runtime-operational-surface](backlog/runtime-operational-surface.md) [tooling] — Runtime §14 Option B: view+executor CLI over derived state, every mutation via the capability seam. Deferred from SPEC 3 (fork Q2). `[epic:runtime-operationalization · core]`
