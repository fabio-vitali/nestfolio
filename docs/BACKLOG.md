...
rollup: core 23/28 done · captured 2/12 done
- core · active · [run-next-fulfil-badpair-guard](backlog/run-next-fulfil-badpair-guard.md)
...
- core · parking · [from-spine-adapters-cli-seam-conformance-test](backlog/from-spine-adapters-cli-seam-conformance-test.md)
...
- [run-next-fulfil-badpair-guard](backlog/run-next-fulfil-badpair-guard.md) [bug] — run-next.mjs main() lacks the malformed --fulfil/--value badPair guard run-epic.mjs has — a flag typo silently journals a junk step instead of exiting 2. Backport the WS-4 guard. `[epic:runtime-operationalization · core]`
