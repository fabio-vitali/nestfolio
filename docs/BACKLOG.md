...
rollup: core 27/30 done · captured 2/12 done
- core · queued · [from-run-next-pre-ship-judge-binding-gap](backlog/from-run-next-pre-ship-judge-binding-gap.md)
...
4. [from-run-next-pre-ship-judge-binding-gap](backlog/from-run-next-pre-ship-judge-binding-gap.md) [bug] `[epic:runtime-operationalization · core]`
