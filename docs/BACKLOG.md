...
4. [runtime-make-it-fire](backlog/runtime-make-it-fire.md) [feature] — The thin live path that makes the runtime FIRE on one real trigger and dogfoods the capability seam — the unblocker for the whole operationalization epic. `[epic:runtime-operationalization · core]`
