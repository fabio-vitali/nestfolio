...
rollup: core 25/29 done · captured 2/12 done
- core · queued · [from-classify-lane-runtime-code-misclassified-doc-layer](backlog/from-classify-lane-runtime-code-misclassified-doc-layer.md)
...
4. [from-classify-lane-runtime-code-misclassified-doc-layer](backlog/from-classify-lane-runtime-code-misclassified-doc-layer.md) [bug] `[epic:runtime-operationalization · core]`
5. [from-spine-adapters-cli-seam-conformance-test](backlog/from-spine-adapters-cli-seam-conformance-test.md) [bug] `[epic:runtime-operationalization · core]`
