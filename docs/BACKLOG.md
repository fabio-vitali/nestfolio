...
rollup: core 21/26 done · captured 2/12 done
- core · queued · [epic-clean-fixture-twin-id-typo](backlog/epic-clean-fixture-twin-id-typo.md)
...
4. [epic-clean-fixture-twin-id-typo](backlog/epic-clean-fixture-twin-id-typo.md) [tooling] — epic-clean fixture e.md names its consumer twins rt-epic-* but the shipped scenario ids are rt-bne-ship-clean / rt-bne-e8-auto-no-self-merge — comment drift, grep trap. `[epic:runtime-operationalization · core]`
