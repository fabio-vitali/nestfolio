...
**Blocked on:** `runtime-replatform-prereqs` (parity-hole #1 makes `Finding.check` optional; the flag +
oracle mapping live there). Promote once that ships.
