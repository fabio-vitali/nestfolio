...
**Blocked on:** `runtime-replatform-prereqs`. Promote once that ships. This member is the primary risk carrier
(spec §14) — a real evaluator over a real AWS deploy.
