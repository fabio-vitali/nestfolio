...
upgraded: this is core ledger money math, not only tax-lot tracking. Promote alongside
`broker-ctrl-order-sf-input-contract-gap` when hardening the order→ledger money path.
