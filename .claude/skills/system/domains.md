...
## Cross-Domain Event Topology

```
Advisory ──→ Investor (via advisory-adpt):
...
Execution ──→ Advisory (via execution-adpt):
...
Ledger ──→ Advisory (via ledger-adpt):
